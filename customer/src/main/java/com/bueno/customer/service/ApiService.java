...
public class ApiService {
    ...
    private void scheduleFixedDelayTask() {
        ...
        for (int i = 0; i < numberOfTasks; i++) {
            taskScheduler.scheduleAtFixedRate(this::sendData, Duration.ofMillis(10));
        }
    ...
    public void sendData() {
        ...
        String hostname = responseEntity.getHeaders().getFirst("hostname");
        String responseBody = responseEntity.getBody();

        //log.info("Sending data to API {}\nResponse {}\nHostname {}\n--------", request, responseBody, hostname);
    }
}
